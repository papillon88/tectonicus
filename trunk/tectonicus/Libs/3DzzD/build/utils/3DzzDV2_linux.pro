-injars ../debug/classes
-outjars ../release/classes

-libraryjars '<java.home>/lib/rt.jar'
-libraryjars ../../lib/timer.jar
-libraryjars ../../lib/jogl.jar
-libraryjars ../../lib/netscape.jar
-libraryjars ../../lib/gluegen-rt.jar
...
-keep public class net.dzzd.* {
    public protected <methods>;
}

-keep public class net.dzzd.utils.io.IOManager {
    public protected <methods>;
}


-keep public interface  net.dzzd.access.* {
    public <methods>;
}

-keep public class net.dzzd.DzzD {
    public <fields>;
    public <methods>;
}

-keep public class net.dzzd.utils.* {
    public <fields>;
    public <methods>;
}

-keep public class net.dzzd.extension.loader.* {
    public <fields>;
    public <methods>;
}

-keep public class net.dzzd.extension.jogl.* {
    public <fields>;
    public <methods>;
}
